<footer class="footer" aria-labelledby="footer">
    ...
    <div class="footer__home">
        <a href="<?= home_url() ?>">
            <svg version="1.1" id="footer__svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                 viewBox="0 0 42 48" height="48" width="42" xml:space="preserve">
                <style type="text/css">
                    .footer__logo{fill:#234738;}
                </style>
